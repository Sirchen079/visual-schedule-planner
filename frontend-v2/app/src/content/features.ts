...
export const FEATURE_LESSONS: FeatureLesson[] = [
  ...
  },
  {
    ...
    steps: ['“悬浮窗与通知”中设置桌面小窗、通知和更新；“外观与 AI 助手”中设置主题、权限和工作时间。', '在“AI 模型”添加并启用模型，在“联网与视觉”配置搜索、网页和图片服务。', '可让 AI 将方法和文件整理成技能，之后按需调用；“技能”中可查看、编辑和分别启停。“外部工具”连接 MCP 服务，“授权”查看和撤回永久授权。', '在“自动跟进”设置持续检查和自动安排。模型配置的详细步骤见 AI 接入教程。'],
