...
class AIConfig(Base):
    ...
    prompt_cache_mode: Mapped[str] = mapped_column(String(24), default='auto')
    prompt_cache_ttl: Mapped[str] = mapped_column(String(8), default='5m')
    prompt_cache_key: Mapped[bool | None] = mapped_column(Boolean)
